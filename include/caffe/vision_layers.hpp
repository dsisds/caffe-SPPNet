...
class ConvolutionLayer : public Layer<Dtype> {
 public:
  ...
  virtual inline int kernel_h() const { return kernel_size_; }
  virtual inline int kernel_w() const { return kernel_size_; }
  virtual inline int stride_h() const { return stride_; }
  virtual inline int stride_w() const { return stride_; }
  virtual inline int padding_h() const { return pad_; }
  virtual inline int padding_w() const { return pad_; }
 ...
 protected:
  ...
  virtual void Backward_gpu(const vector<Blob<Dtype>*>& top,
      const vector<bool>& propagate_down, vector<Blob<Dtype>*>* bottom);
  virtual void spp_Forward_region_cpu(const vector<Blob<Dtype>*>& bottom,
	  vector<Blob<Dtype>*>* top, const vector<int>& bbox){
	NOT_IMPLEMENTED;
  }
  virtual void spp_Forward_region_gpu(const vector<Blob<Dtype>*>& bottom,
	  vector<Blob<Dtype>*>* top, const vector<int>& bbox){
	NOT_IMPLEMENTED;
  }
...
class PoolingLayer : public Layer<Dtype> {
 public:
  ...
  virtual inline int kernel_h() const { return kernel_h_; }
  virtual inline int kernel_w() const { return kernel_w_; }
  virtual inline int stride_h() const { return stride_h_; }
  virtual inline int stride_w() const { return stride_w_; }
  virtual inline int padding_h() const { return pad_h_; }
  virtual inline int padding_w() const { return pad_w_; }
...
class SpatialPyramidPoolingLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  virtual void spp_Forward_region_gpu(const vector<Blob<Dtype>*>& bottom,
	  vector<Blob<Dtype>*>* top, const vector<int>& bbox);
	//spp_Forward_region_cpu(bottom, top, bbox);
